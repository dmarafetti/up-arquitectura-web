...
- **Apuntes de cátedra (Google Slides)** — *Browsers* (módulo Browsers Parte 1), diapositivas sobre la principal funcionalidad del navegador, arquitectura cliente-servidor, componentes del navegador y motor de renderización (Blink, Gecko, WebKit), etapas del camino crítico de renderizado y reflow. Documento de cátedra, id de Google Drive `1-fKc3822ivrqT3fAmXppUwDCR66fLaM1`.
